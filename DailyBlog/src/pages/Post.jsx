...
function Post() {
  ...
  return post ? (
    <div className="min-h-screen bg-gradient-to-br from-gray-200  to-gray-600py-4 sm:py-8">
      <Container>
                  ...
                  <div className="flex items-center space-x-3 ">
                    <Link to={`/edit-post/${post.$id}`}>
                      <Button 
                        ...
                        className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gray-500 rounded-lg hover:bg-emerald-600 transition-all duration-200 hover:scale-105 shadow-md hover:shadow-lg"
                      >
                    ...
                    <Button 
                      bgColor="bg-red-500" 
                      onClick={deletePost}
                      className="inline-flex items-center bg-gray-500 px-4 py-2 text-sm font-medium text-white rounded-lg hover:bg-red-600 transition-all duration-200 hover:scale-105 shadow-md hover:shadow-lg"
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
